  ...
  return (
    <section className="panel chart-panel">
      <div className="panel-heading">
        ...
        <span className="source-label">{diseaseName.includes('HPAI') ? 'WOAH WAHIS' : diseaseName.includes('Nipah') || diseaseName.includes('Japanese') ? 'Peer-reviewed literature' : 'DGHS aggregate surveillance'}</span>
      </div>
